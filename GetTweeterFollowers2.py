...
for tweeter in tweeters:
        ...
        if os.path.isfile(fileName):
            ...
            try:
                    subcommand = '../influence_measure/virtual/bin/python fetchFollowers.py ' + tweeter
                    p = subprocess.call(['../influence_measure/virtual/bin/python', 'fetchFollowers.py', tweeter])
